...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" class="search-submit" title="<?php echo esc_attr_x( 'Search', 'submit button', 'gridd' ); ?>">
		...
		<span class="screen-reader-text"><?php echo esc_attr_x( 'Search', 'submit button', 'gridd' ); ?></span>
	</button>
</form>

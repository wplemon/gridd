...
function gridd_nav_customizer_options( $id ) {
	...
	gridd_add_customizer_field(
		[
			...
			'choices'         => [
				'flex-start'    => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'Start', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'Start', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M512.002 512.002V0H0v512.002z"/><path d="M512 375.568H0v-218.46h512zm-19.246-19.246V176.354H19.246v179.968z"/><path d="M40.646 231.338h70v70h-70zM128.504 231.338h70.001v70h-70z"/></svg></span>',
				'flex-end'      => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'End', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'End', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M0 512V-.003h512.002v512.001z"/><path d="M0 375.568h512v-218.46H0zm19.246-19.246V176.354h473.508v179.968z"/><path d="M471.353 231.339h-70v70h70zM383.494 231.339h-70v70h70z"/></svg></span>',
				'center'        => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'Center', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'Center', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M0 512V0h512.002v512z"/><path d="M0 375.568h512v-218.46H0zm19.246-19.246V176.354h473.508v179.968z"/><path d="M334.93 231.336h-70v70.001h70zM247.071 231.336h-70v70.001h70z"/></svg></span>',
				'space-between' => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'Space Between', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'Space Between', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M.002 512V0h512.001v512z"/><path d="M0 375.568h512v-218.46H0zm19.246-19.246V176.354h473.508v179.968z"/><path d="M477.851 231.336h-70v70.001h70zM104.147 231.336H34.146v70.001h70z"/></svg></span>',
				'space-around'  => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'Space Around', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'Space Around', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M.002 512V-.003h512.001v512.001z"/><path d="M0 375.568h512v-218.46H0zm19.246-19.246V176.354h473.508v179.968z"/><path d="M423.81 231.339h-70.001v70h70zM158.192 231.339h-70v70h70z"/></svg></span>',
				'space-evenly'  => '<span class="gridd-flexbox-svg-option" title="' . esc_attr__( 'Space Evenly', 'gridd' ) . '"><span class="screen-reader-text">' . esc_html__( 'Space Evenly', 'gridd' ) . '</span><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><path d="M.002 512.002V0h512.001v512.002z"/><path d="M0 375.568h512v-218.46H0zm19.246-19.246V176.354h473.508v179.968z"/><path d="M383.402 231.338h-70v70h70zM198.599 231.338h-70.001v70h70z"/></svg></span>',
			],
		]
	);

...
<div id="gridd-handheld-home">
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="gridd-nav-handheld-btn home">
		...
		<span class="<?php echo get_theme_mod( 'gridd_grid_nav-handheld_hide_labels', false ) ? 'screen-reader-text' : 'label'; ?>">

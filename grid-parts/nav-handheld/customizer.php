...
gridd_add_customizer_section(
	...
	[
		...
		'description' => sprintf(
			...
			( ! Gridd::is_pro() ) ? '<div class="gridd-go-plus">' . __( '<a href="https://wplemon.com/gridd-plus" rel="nofollow" target="_blank">Upgrade to <strong>plus</strong></a> to add a custom widget-area as a new menu item in mobile navigation.', 'gridd' ) . '</div>' : '',
...
gridd_add_customizer_field(
	[
		...
		'label'           => esc_attr__( 'Hide Labels', 'gridd-plus' ),
		'description'     => __( 'Enable this option if you want to hide the button labels. If labels are hidden, they only become available to screen-readers.', 'gridd-plus' ),
		'section'         => 'gridd_grid_part_details_nav-handheld',
		'default'         => false,
		'transport'       => 'postMessage',
		'partial_refresh' => [

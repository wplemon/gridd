...
gridd_add_customizer_field(
	[
		...
		'description' => __( 'Inner padding for all parts in the footer. For details on how padding works, please refer to <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/padding" target="_blank" rel="nofollow">this article</a>.', 'gridd' ),
		'section'     => 'gridd_grid_part_details_footer',
		'default'     => '1em',
		'transport'   => 'postMessage',
...
gridd_add_customizer_field(
	[
		...
		'description' => esc_html__( 'Choose a background color for the footer. Individual grid-parts can override this by setting their own background color for their area. If you are using a grid-gap the color defined here will be visible between grid-parts.', 'gridd' ),
		'section'     => 'gridd_grid_part_details_footer',
		'default'     => '#ffffff',
		'transport'   => 'postMessage',
...
gridd_add_customizer_field(
	[
		...
		'description' => esc_html__( 'You can make the top border of the footer ticker or thinner by adjusting this value. Set to 0 to disable the top border.', 'gridd' ),
		'section'     => 'gridd_grid_part_details_footer',
		'default'     => 1,
		'transport'   => 'postMessage',
...
gridd_add_customizer_field(
	[
		...
		'label'           => esc_html__( 'Border-top Color', 'gridd' ),
